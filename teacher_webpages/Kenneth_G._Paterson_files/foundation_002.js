...
(function(document, Granite, CUI, $) {
    ...
    $(document).on("click", ".foundation-admin-layouttoggle-item", function(e) {
        ...
        Granite.UI.Foundation.Layouts.switchLayout($(Granite.UI.Foundation.XSS.sanitizeHtml(target)).get(0), layout);
...
(function(window, document, $, URITemplate, Granite) {
    ...
    $(document).on("click", ".foundation-admin-properties-activator", function(e) {
        ...
        var item = activator.dataset.foundationCollectionItem;
        if (item) {
            selections = document.querySelectorAll(item);
        } else {
            var config = $activator.data("foundationCollectionAction");
            var target = document.querySelector(config.target);
            selections = target.querySelectorAll(".foundation-selections-item");
        }
